...
# python -m pytest -s tests\test_update_purchase_group.py -k test_correct_delta_f


# Тестирование загрузки справочника "Группа закупок"
...
# Авторизация и получение необходимых cookie и headers
    ...
    def setup(self):
        ...
        self.url = "http://localhost:83/0/rest/SapErpIntegrationService/v1/UpdatePurchaseGroups"
...
# Проверка возможности создания записи без обязательных полей режим "F" (пустой "EKGRP")
