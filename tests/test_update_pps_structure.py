...
# Проверка возможности создания записи без обязательных полей режим "F" (пустой "POST1")

    def test_null_post1_value_delta_f(self):
        json_data = {
            "currentPage": "1",
            "pageCount": "1",
            "delta": "F",
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 7",
                    "POSID": "main test code 7",
                    "POST1": "",
                    "ERDAT": "01.01.20",
                    "AEDAT": "31.12.21",
                    "VERNR": "IteItemResponsible 7",
                    "USR00": "IteFinancingType 7",
                    "USR01": "IteCSSCode 7",
                    "ZZ_NAPRD": "IteActivityDirection 7",
                    "deleted": ""
                }
            ]
        }
        ...
        obj = json.loads(response.text)
        for result in obj['result']:
            assert result['MESSAGE'] == "Обязательно для заполнения - POST1", f"The value of 'MESSAGE' is not correct"
            assert result['TYPE'] == "E", f"The value of 'TYPE' is not correct"
            ...
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 8",
                    "POSID": "main test code 8",
                    "POST1": "IteItemName 8",
                    "ERDAT": "",
                    "AEDAT": "31.12.21",
                    "VERNR": "IteItemResponsible 8",
                    "USR00": "IteFinancingType 8",
                    "USR01": "IteCSSCode 8",
                    "ZZ_NAPRD": "IteActivityDirection 8",
                    "deleted": ""
                }
            ]
        }
            ...
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 9",
                    "POSID": "main test code 9",
                    "POST1": "IteItemName 2",
                    "ERDAT": "01.01.20",
                    "AEDAT": "",
                    "VERNR": "IteItemResponsible 9",
                    "USR00": "IteFinancingType 9",
                    "USR01": "IteCSSCode 9",
                    "ZZ_NAPRD": "IteActivityDirection 9",
                    "deleted": ""
                }
            ]
        }
...
# Проверка возможности создания записи без обязательных полей режим "F" (пустой "USR00")

    def test_null_usr00_value_delta_f(self):
        json_data = {
            "currentPage": "1",
            "pageCount": "1",
            "delta": "F",
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 11",
                    "POSID": "main test code 11",
                    "POST1": "IteItemName 11",
                    "ERDAT": "01.01.20",
                    "AEDAT": "31.12.21",
                    "VERNR": "IteItemResponsible 11",
                    "USR00": "",
                    "USR01": "IteCSSCode 11",
                    "ZZ_NAPRD": "IteActivityDirection 11",
                    "deleted": ""
                }
            ]
        }
        ...
        obj = json.loads(response.text)
        for result in obj['result']:
            assert result['MESSAGE'] == "Обязательно для заполнения - USR00", f"The value of 'MESSAGE' is not correct"
            assert result['TYPE'] == "E", f"The value of 'TYPE' is not correct"


# Проверка возможности создания записи без обязательных полей режим "F" (пустой "USR01")

    def test_null_usr01_value_delta_f(self):
        json_data = {
            "currentPage": "1",
            "pageCount": "1",
            "delta": "F",
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 12",
                    "POSID": "main test code 12",
                    "POST1": "IteItemName 12",
                    "ERDAT": "01.01.20",
                    "AEDAT": "31.12.21",
                    "VERNR": "IteItemResponsible 12",
                    "USR00": "IteFinancingType 12",
                    "USR01": "",
                    "ZZ_NAPRD": "IteActivityDirection 12",
                    "deleted": ""
                }
            ]
        }
        ...
        obj = json.loads(response.text)
        for result in obj['result']:
            assert result['MESSAGE'] == "Обязательно для заполнения - USR01", f"The value of 'MESSAGE' is not correct"
            assert result['TYPE'] == "E", f"The value of 'TYPE' is not correct"


# Проверка возможности создания записи без обязательных полей режим "F" (пустой "ZZ_NAPRD")

    def test_null_zznaprd_value_delta_f(self):
        json_data = {
            "currentPage": "1",
            "pageCount": "1",
            "delta": "F",
            "item": [
                {
                    "row": "1",
                    "PBUKR": "IteBUCode 13",
                    "POSID": "main test code 13",
                    "POST1": "IteItemName 13",
                    "ERDAT": "01.01.20",
                    "AEDAT": "31.12.21",
                    "VERNR": "IteItemResponsible 13",
                    "USR00": "IteFinancingType 13",
                    "USR01": "IteCSSCode 13",
                    "ZZ_NAPRD": "",
                    "deleted": ""
                }
        ...
        obj = json.loads(response.text)
        for result in obj['result']:
            assert result['MESSAGE'] == "Обязательно для заполнения - ZZ_NAPRD", f"The value of 'MESSAGE' is not correct"
            assert result['TYPE'] == "E", f"The value of 'TYPE' is not correct"
